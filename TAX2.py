# Name  Gabe Dyer
# Prog Purpose: Taxes 2 electric boogaloo 
import datetime
PPT_RATE = .042
RELIEF_RATE = .33
...
owner_name = ["Brand,Debra      ", "Smith,Carter     ", "Johnson,Bradley    ", "Gracia,Jennifer  ", "Henderson,Leticia", "White, Danielle   "]
ppt_owed = []
num_vechicles = len(vehicle)
tax_due = 0
total = 0
